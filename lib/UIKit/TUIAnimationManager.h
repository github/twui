...
// The TUIAnimationManager class is meant to be used as a singleton. 
// Developers should avoid creating mulitple instances and should 
// get a reference to an instance via the sharedManager class method.
...
// Get a reference to the TUIAnimationManager singleton.
+ (TUIAnimationManager *)sharedManager;
...
// with one of the TUIAnimationManager animations. If you want 
...
// All animations created by TUIAnimationManager are created by this method.
